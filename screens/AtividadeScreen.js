...
export default AtividadeScreen = () => {
    ...
    const pesquisar = async () => {
        try {
            const url = `http://localhost:3000/atividade/porNome/${texto}`
    ...
    return (
        <SafeAreaView style={styles.container1}>
            ...
            <Text style={styles.textoTitulo1} >Atividade</Text>
            ...
            <ScrollView style={styles.containerResultado}>
                {
                    atividades.map( (atividadeAtual) => {
                        return(
                            <CardAtividadeComp key={atividadeAtualAtual._id} atividade={atividadeAtual} />
                        )
                    })
                }
            </ScrollView>
